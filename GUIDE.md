...
Use this for onboarding new tenants, training facility managers, and helping non-admin staff quickly learn the system.
...
Tip for recording: Keep browser zoom around 90-100% so dashboards, tables, and modals are easy to read.

---

## Scene 1: Intro (Voiceover Script)
...
By the end of this video, you will know how to log in, navigate key pages, create and manage schedules, process time-off workflows, and use internal messaging.
...
These values drive consistency across staff profiles, coverage planning, and schedule generation.

Best practice: complete this setup first, then build coverage and schedules.
...
For larger onboarding, use bulk CSV import.

When editing staff, define capability-related fields such as allowed areas, shift tags, shift types, and certification tags to improve scheduling accuracy.
...
Admins can also view their own personal requests in My Time Off Requests.
...
Use Messages for internal communication and faster operational coordination.
...
After successful checkout, the app refreshes tenant status and unlocks full operational access.

---

## Scene 4: Non-Admin Staff Walkthrough
...
Take action based on status, and monitor outcomes in real time.
...
You can then monitor whether each request is pending, approved, or denied.
...
Keeping preferences up to date helps improve schedule quality and fit.
...
4. Update Schedule drafts and publish changes.
...
- Ignoring message threads during active schedule changes
- Letting staff preferences become outdated

---

## Scene 7: Closing Script

WiserShifts is designed to help your facility run smoother by connecting staffing requirements, schedules, and communication in one place.

Admins can plan and optimize operations at scale.

Staff can manage their own schedule, requests, swaps, and communication with clarity.

Use this guide as your reference for onboarding, refresher training, and team standardization.
...
- Pause after each major section and take questions.
- If users are brand new, run two short demos:
  - 5-minute admin rapid flow
  - 5-minute staff rapid flow
- Record one version per audience for easier replay.
